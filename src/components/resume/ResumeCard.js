...
const ResumeCard = ({ title, subTitle, result, des }) => {
  return (
    <div className="w-full h-1/3 group flex ">
      ...
      <div className="w-full bg-cardColor hover:bg-black duration-400 group-hover:text-white rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10">
